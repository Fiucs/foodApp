...
public class DES {
    /**
     * 获取加密密钥Key     * @param keyString     * @return
     */
    ...
    /**
     * 将byte数组转换成16进制String     * @param bytes     * @return     * @throws Exception
     */
    ...
    /**
     * 将16进制string转换成byte数组     * @param str     * @return     * @throws Exception
     */
    ...
    /**
     * 对字符串进行DES加密     * @param val 原始字符串     * @param key 加密使用的key     * @return     * @throws Exception
     */
    ...
    /**
     * 对DES加密后的16进制字符串进行解密     * @param val     * @param key     * @return     * @throws Exception
     */
