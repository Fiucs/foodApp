...
public class CommentExpandAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(final int groupPosition, boolean isExpand, View convertView, ViewGroup viewGroup) {
        ...
        groupHolder.commentId.setText(String.valueOf(commentBeanList.get(groupPosition).getReplyId()));//设置评论ID
        groupHolder.tv_name.setText(commentBeanList.get(groupPosition).getNickName());
        groupHolder.tv_time.setText(String.valueOf( commentBeanList.get(groupPosition).getCreateDate()));
    ...
    private class GroupHolder{
        ...
        private TextView tv_name, tv_content, tv_time,commentId;
        ...
        public GroupHolder(View view) {
            ...
            commentId=view.findViewById(R.id.commentId);//获取评论Id
        }
    }
     ...
     * func:评论成功后插入一条数据  通过网络方式提交给服务器
     * @param commentDetailBean 新的评论数据
     */
    public void addTheCommentData(CommentDetailBean commentDetailBean, CommentExpandableListView commentExpandableListView){
        if(commentDetailBean!=null){

            commentBeanList.add(commentDetailBean);
            commentExpandableListView.expandGroup(commentBeanList.size()-1);
