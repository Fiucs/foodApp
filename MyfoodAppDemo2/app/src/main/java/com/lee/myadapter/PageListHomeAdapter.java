...
public class PageListHomeAdapter extends PagedListAdapter<FoodsBean,PageListHomeAdapter.MyviewHolder>{
    ...
    public PageListHomeAdapter(MutableLiveData<Boolean> netWork, int width, int height , LayoutInflater inflater, ViewGroup container) {
...
//        Log.d("网络状态：",isNetWorkOk+"");
        ...
        {
                viewitem=inflater.inflate(R.layout.card_view,parent,false);
...
//        imaegeParams.width=(width/2-2);
        ...
        imageViewParams.height=height/4+randomH;
